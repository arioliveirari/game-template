...
import { globalState } from "../../scenes/globalData/GlobalDataManager";
...
export default class ToolTips {
  ...
  constructor(scene: PossibleScenesTypes) {
    this.scene = scene;
  }
...
export const GetPointFromWorld = (point: Phaser.Geom.Point, scene: PossibleScenesTypes) => {
