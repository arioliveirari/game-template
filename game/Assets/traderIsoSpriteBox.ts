...
export class TraderIsoSpriteBox extends RpgIsoSpriteBox {
  ...
  updateTrader(group: Phaser.GameObjects.Group) {
    ...
    this.self.on("pointerdown", () => {
      this.eventCenter.emitEvent(this.eventCenter.possibleEvents.OPEN_MODAL, { modalType: modalType.TRADE, pin: this, tradeIds: [1, 2] });
